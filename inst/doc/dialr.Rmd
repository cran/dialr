...
dialr is an R interface to [Google's libphonenumber java library](https://github.com/googlei18n/libphonenumber).
...
[Frequently Asked Questions](https://github.com/googlei18n/libphonenumber/blob/master/FAQ.md)
